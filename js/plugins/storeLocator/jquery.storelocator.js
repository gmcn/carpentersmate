...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		// Templates
		'infowindowTemplatePath'     : '/wp-content/themes/carpentersmate/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'           : '/wp-content/themes/carpentersmate/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath'  : '/wp-content/themes/carpentersmate/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : '/wp-content/themes/carpentersmate/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
		...
		createMarker: function (point, name, address, letter, map, category) {
			...
			if (this.settings.callbackCreateMarker) {
				...
				if (this.settings.disableAlphaMarkers === true || this.settings.storeLimit === -1 || this.settings.storeLimit > 26 || this.settings.catMarkers !== null || this.settings.markerImg !== null || (this.settings.fullMapStart === true && firstRun === true && (isNaN(this.settings.fullMapStartListLimit) || this.settings.fullMapStartListLimit > 26 || this.settings.fullMapStartListLimit === -1))) {
					...
					letterMarkerImg = {
						url: '/wp-content/themes/carpentersmate/images/marker.svg'
					};
